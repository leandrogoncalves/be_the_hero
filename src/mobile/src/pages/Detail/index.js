...
export default function Detail(){
    ...
    const message = `Olá, estou entrando em contato para ajudar no caso com o valor de R$ `;
    ...
    function sendMail(){
        MailComposer.composeAsync({
            subject: 'Ajuda no caso',
            recipients: ['leandro@gmail.com'],
            body: message
        });
    }

    function sendWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=11981382429&text=${message}`);
    }
